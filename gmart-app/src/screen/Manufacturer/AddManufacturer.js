...
const ShopInput = ({navigation}) => {
  ...
  const {name, latitude, longitude, description, location, comment} = state;
  ...
  const apply = async () => {
    ...
    if (
      ...
      await Api.addManufacturer(raw, (err, res) => {
  ...
  const addSelectedKeyword = index => {
    ...
    else selectedKeywords.push(index);
  ...
  return (
    <View
      ...
      <TopnavBar title={'Add Manufacturer'} />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.block}>
          <TextInputCom
            ...
            onChangeText={comment =>
              handleChange({key: 'comment', value: comment})
            }
            value={comment}
            onSubmitEditing={() => {
        ...
        <View style={styles.block}>
          <View style={styles.coordinatesname}>
            <AutoText title="Latitude" variable={latitude} />
            <AutoText title="Longitude" variable={longitude} />

            <TouchableOpacity style={styles.buttonStyle} onPress={setPosition}>
        ...
        <View
          ...
          <ScrollView
            ...
            <Badges
              items={keywordsData}
              textStyle={styles.keywordsStyle}
              touchable={true}
              onPressBadge={addSelectedKeyword}
              alignWidth={290}
            />
          </ScrollView>
          <TouchableOpacity
      ...
      />
      <Modal transparent visible={isNewKeyword} onRequestClose={offNewKeyword}>
        <TouchableOpacity
          style={{
            flex: 1,
          }}
